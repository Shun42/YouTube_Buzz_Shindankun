...
#### 2.1 このソフトの開発動機
私は音楽制作をし、YouTubeに成果物として動画をアップロードしております。  
その際、再生数が伸びる動画にはどのような傾向があるのかを知りたくなり、様々な角度から分析するソフトをデータサイエンスと絡めて制作することにいたしました。

#### 2.2 このソフトで解決したい課題  
YouTubeの再生回数の増加要因を調査し、バズりやすい動画の特徴を可視化することです。

#### 2.3 どのような人・場面を想定したソフトか  
...
算定した特徴量から動画のバズの要因を特定します。  

#### 3.2 分析結果からわかること  
どのような要因が再生数増加と関連があるのか  
...
#### 4.1 データ一覧画面
![データ一覧](screencapture-127-0-0-1-5000-result-2026-06-24-13_57_56.png)
取得した動画データ、再生数、高評価数、コメント数、各種特徴量などを一覧で確認できます。
#### 4.2 特徴量の可視化画面
![どの特徴量が再生数増加と関係があったか(SHAP値)](image-1.png)
...
![各strong_wordsのスコアによるバズ傾向の分類](image.png)
